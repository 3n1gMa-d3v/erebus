...
- Fix: Rescanning of ATXO (Also fixes [#45](https://github.com/3n1gMa-d3v/phantom-wallet-archive/issues/45))
...
- Automatic Build improvements:
  - All wallets show now their build commit hash in the about dialog and on the main window title. ([#117](https://github.com/3n1gMa-d3v/phantom-wallet-archive/issues/117))
...
- [#26](https://github.com/3n1gMa-d3v/phantom-wallet-archive/issues/26) Fix status icon tooltips offscreen when scrolled down past header text
- [#31](https://github.com/3n1gMa-d3v/phantom-wallet-archive/issues/31) Fix Connectivity bar not visible on high DPI settings
- [#65](https://github.com/3n1gMa-d3v/phantom-wallet-archive/issues/65) Fix wallet immediately closed after walletpassphrase via console Win 8.1
- [#69](https://github.com/3n1gMa-d3v/phantom-wallet-archive/issues/69) Fix Transaction ID in transaction detail dialog: link behavior error
- [#74](https://github.com/3n1gMa-d3v/phantom-wallet-archive/issues/74) Change 'Spectre' to 'Spectrecoin'; update logo images
- [#75](https://github.com/3n1gMa-d3v/phantom-wallet-archive/issues/75) Fix Wrong fee calculation when transfer from private to public

## 2.0.5
- [#40](https://github.com/3n1gMa-d3v/phantom-wallet-archive/issues/40) / [#53](https://github.com/3n1gMa-d3v/phantom-wallet-archive/issues/53) support cyrillic usernames by using the unicode function of windows to fetch the pathname (Windows)
- [#42](https://github.com/3n1gMa-d3v/phantom-wallet-archive/issues/42) Remove additional UI id chars from transaction ID when copy/paste
- [#50](https://github.com/3n1gMa-d3v/phantom-wallet-archive/issues/50) Change text 'No combination of coins matches amount and ring size' to 'No combination of (mature) coins matches amount and ring size.'
- [#64](https://github.com/3n1gMa-d3v/phantom-wallet-archive/issues/64) DCB staking rewards are labeled 'Contributed'
