...
BOOST_AUTO_TEST_CASE(key_test1)
{
    ...
    BOOST_CHECK(addr1  == CBitcoinAddress(CTxDestination(pubkey1.GetID())));
    BOOST_CHECK(addr2  == CBitcoinAddress(CTxDestination(pubkey2.GetID())));
    BOOST_CHECK(addr1C == CBitcoinAddress(CTxDestination(pubkey1C.GetID())));
    BOOST_CHECK(addr2C == CBitcoinAddress(CTxDestination(pubkey2C.GetID())));
