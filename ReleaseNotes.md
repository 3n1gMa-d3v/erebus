...
> to support the long term development and value of Phantom. The fund is managed
> by the Phantom core team.

This is a major release and a **MANDATORY** update to the Phantom software!
...
to the Phantom network and you will no longer be able to conduct transactions on
the network and you will no longer be able to deposit or withdraw your funds
(public a/o private PHM) from the exchanges.

### Development Contribution Blocks (DCB)
After 21/08/2018 @ 2200 hours (GMT) one in six (1 in 6) block rewards will be
a designated DCB and will be sent to the Phantom team development fund wallet.
This fund will ensure a future for Phantom and will enable us to pay for certain
services, to hire contractors and to pay Phantom core team members in PHM
...
updated will not be able to create transactions on the Phantom V3 network.
...
- [#14](https://github.com/3n1gMa-d3v/phantom-wallet-archive/issues/14) Localization of main wallet
- Localization of Windows installer and Shell-UI
- [#280](https://github.com/3n1gMa-d3v/phantom-wallet-archive/issues/280) Fixed cmdline option `-help` (`-h`)
...
- [#3](https://github.com/3n1gMa-d3v/phantom-wallet/issues/3) 32Bit Windows (x86) version available now
- [#27](https://github.com/3n1gMa-d3v/phantom-wallet/issues/27) Fixed thread safety issue which leads to wallet crash during heavy load on the RPC interface. Thx @Gandalf for the finding!

## 4.3.1 (released 2020-12-08)
- Update to Qt 5.12.10 (Mac)
- [#227](https://github.com/3n1gMa-d3v/phantom-wallet-archive/issues/227) On startup, always require password if wallet is encrypted.
- SetupWalletWizard
  - Encryption of wallet.dat is now part of the wizard and mandatory.
  - [#248](https://github.com/3n1gMa-d3v/phantom-wallet-archive/issues/248) Added password verification field next to password.
...
- [#183](https://github.com/3n1gMa-d3v/phantom-wallet-archive/issues/183) Reduce UI freezes during blockchain sync.

## 4.1.0 (released 2019-10-13)
- [#82](https://github.com/3n1gMa-d3v/phantom-wallet-archive/issues/82) Wallet.dat creation with mnemonic seed words (BIP39).
  ...
  Duplicated by [#115](https://github.com/3n1gMa-d3v/phantom-wallet-archive/issues/115)

- [#214](https://github.com/3n1gMa-d3v/phantom-wallet-archive/issues/214) Migrate Debian/Raspbian build to Buster.
  Binaries for both Stretch and Buster will be provided.

- [#216](https://github.com/3n1gMa-d3v/phantom-wallet-archive/issues/216) Tor Hidden Service v3 implementation + minor Tor improvements.
...
- [#218](https://github.com/3n1gMa-d3v/phantom-wallet-archive/issues/218) Provide binaries for Ubuntu 19.04.
